//C:\Users\ASUS\Downloads\mern-ecommerce-main\mern-ecommerce-main\frontend\src\features\products\components\ProductList.jsx
...

    {
        ...
        <motion.div
            ...
            <Stack mb={'5rem'}>
                ...
                {/* ✅ CATEGORY LIST (THAY CHO TOTES + CATEGORY) */}
                <Stack rowGap={2} mt={4}>
                {categories?.map((category) => (
                    ...
                    sx={{
                        cursor: "pointer",
                        fontWeight: filters.category?.includes(category._id) ? "bold" : "normal",
                        color: filters.category?.includes(category._id) ? "black" : "gray"
                    }}
                    onClick={() => {
