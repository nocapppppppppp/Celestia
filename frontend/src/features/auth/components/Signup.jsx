...

      {
        ...
        <Stack flex={1} justifyContent={'center'} alignItems={'center'}>
              ...
              <Stack flexDirection={'row'} justifyContent={'center'} alignItems={'center'}>
                  <Stack rowGap={'.4rem'}>
                    <Typography variant='h2' sx={{wordBreak:"break-word"}} fontWeight={600}>Celestia</Typography>
                    <Typography alignSelf={'flex-end'} color={'GrayText'} variant='body2'>Fine Sliver Jewelry</Typography>
                  </Stack>
